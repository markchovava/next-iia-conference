    ...
    <section id="package" className='w-full pt-[4rem] pb-[5rem] bg-gray-50'>
        ...
        <div className="mx-auto w-[92%] grid lg:grid-cols-3 grid-cols-1 gap-8">
            <div className='bg-white drop-shadow-lg rounded-2xl'>
                <h2 className='font-serif font-extrabold text-center text-4xl mb-4 pt-4 px-4'>BASIC</h2>
                <p className='w-[100%] font-extrabold bg-teal-900 text-gray-100 text-center text-[2rem] py-1'>
                    $30.00</p>
            ...
            <div className='bg-white drop-shadow-lg rounded-2xl'>
                <h2 className='font-serif font-extrabold text-center text-4xl mb-4 pt-4 px-4'>
                    STANDARD</h2>
                <p className='w-[100%] font-extrabold bg-teal-900 text-gray-100 text-center text-[2rem] py-1'>
                    $60.00</p>
                <ul className='px-3 font-light flex flex-col items-center justify-center gap-2 py-3 border-b border-gray-300 mb-3'>
